# tests/simulation/movementInsert/practical_gcmc_systems.py
"""
System creation functions for practical GCMC tests

This module provides various system creation utilities for practical GCMC testing.
"""
