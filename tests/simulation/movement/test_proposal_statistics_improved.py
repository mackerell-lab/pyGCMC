# tests/simulation/movement/test_proposal_statistics_improved.py
"""Improved statistics tests with proper assertions and physics."""
...
class TestMovementStatisticsCorrectness:
    """Test movement statistics with proper validation."""
    
    def test_statistics_basic_counting(self, fresh_system):
    ...
    def test_acceptance_rate_calculation(self, fresh_system):
    ...
    def test_statistics_reset(self, fresh_system):
    ...
    def test_timing_statistics(self, fresh_system):
    ...
    def test_cavity_statistics_consistency(self, fresh_system):
    ...
    def test_statistics_thread_safety(self, fresh_system):
...
class TestProposalStatisticsEdgeCases:
    """Test edge cases and error conditions."""
    
    def test_empty_system_statistics(self):
    ...
    def test_statistics_overflow_protection(self, fresh_system):
