...
class TestDetailedBalance:
    """Test that movements preserve detailed balance."""
    ...
    def test_insertion_deletion_balance(self, setup_system):
    ...
    def test_translation_reversibility(self, setup_system):
    ...
    def test_metropolis_criterion(self, setup_system):
    ...
    def test_cavity_bias_detailed_balance(self, setup_system):
    ...
    def test_config_bias_detailed_balance(self, setup_system):
    ...
    def test_temperature_scaling(self, setup_system):
    ...
    def test_chemical_potential_balance(self, setup_system):
    ...
    def test_ensemble_averages(self, setup_system):
    ...
    def test_rosenbluth_weight_consistency(self, setup_system):
