...
def test_pme_medium_complexity():
    ...
    # Check if error is in expected range (should be between simple and complex)
    assert 1.0 <= best_error <= 15.0, f"Medium complexity error {best_error:.2f}% outside expected range (1-15%)"
