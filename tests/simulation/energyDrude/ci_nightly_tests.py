...
def test_ci_nightly_anisotropic_polarizability():
...
def test_ci_nightly_numerical_force_validation():
...
def test_ci_nightly_water_box_8_molecules():
...
def test_ci_nightly_thole_sensitivity_scan():
...
def test_ci_nightly_performance_scaling():
