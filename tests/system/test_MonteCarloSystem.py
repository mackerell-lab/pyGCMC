...
def test_atom_type_maps_after_movement_molecules():
    ...
    initial_types = set(initial_type_maps.atom_types)
    ...
    final_types = set(final_type_maps.atom_types)
...
def test_compare_add_molecules_together_vs_separate():
    ...
    # Test 2: Compare movement residues info
    ...
    # Test 3: Compare residue organization
    for i in range(state1.activeResidueCount):
