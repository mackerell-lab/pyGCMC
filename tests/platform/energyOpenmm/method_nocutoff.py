# tests/simulation/energyOpenmm/method_nocutoff.py

import pytest
from .method_helpers import *

def test_compare_nonbonded_nocutoff():
    """
    Compare NoCutoff nonbonded method between CustomNonbondedForce and NonbondedForce.
    
    Tests NoCutoff calculation method:
    1. No cutoff:
    ...
    # Test NoCutoff method
    nb_method = NonbondedForce.NoCutoff
    custom_method = CustomNonbondedForce.NoCutoff
    method_name = "NoCutoff"
    
    # Define tolerance for this method
    rel_tol = 1e-6  # Higher precision required for no cutoff
    ...
    # No cutoff settings needed for NoCutoff method
    ...
    # Energy expression for NoCutoff method
    energy_expression = """
    kC * q1 * q2 / r + 
    4 * sqrt(eps1*eps2) * (
    ...
    # No self-energy correction needed for NoCutoff method
