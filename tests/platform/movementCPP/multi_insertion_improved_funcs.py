# tests/simulation/movementCPP/multi_insertion_improved_funcs.py
"""Multi-insertion CBMC improved tests - extracted functions."""

import pytest
import pygcmc
import numpy as np
import time
from .multi_insertion_improved_fixtures import setup_improved_system, has_multi_insertion
from .statistical_utils import *

def test_multi_insertion_basic_strict():
    """Test basic multi-insertion with strict numerical checks."""
    state, params = setup_improved_system()
...
def test_acceptance_rate_statistics():
...
def test_parallel_insertion_performance():
...
def test_detailed_balance_strict():
...
def test_cavity_bias_with_multi_insertion():
