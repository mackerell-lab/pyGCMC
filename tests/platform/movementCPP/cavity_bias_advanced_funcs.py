# tests/simulation/movementCPP/cavity_bias_advanced_funcs.py
"""Advanced cavity bias test functions including thread safety and parameter effects."""
...
def test_cavity_concurrent_access(create_state):
...
def test_cavity_grid_spacing_effect(create_state):
...
def test_probe_radius_effect(create_state):
...
def test_cavity_stats_retrieval(create_state):
